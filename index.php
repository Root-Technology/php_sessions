									...
									<ul>
										<li class="cart-product-item">
											...
											<div class="product-content">
												...
												<ul class="rait-stars">
													<li>
														<svg class="star-icon c-primary" width="10" height="10">
													...
													<li>
														<svg class="star-icon" width="10" height="10">
															<use xlink:href="#olymp-star-null"></use>
														</svg>
													</li>
												</ul>
				...
				<div class="registration-login-form">
					...
					<div class="tab-content" id="registration-form-tabs-content">
						<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
							...
							<form class="content" method="post" action="adduser.php">
								<div class="row">
							...
							<form class="content" id="loginForm">
								...
								<div class="row">
									<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
										...
										<a href="#" class="btn btn-lg bg-facebook full-width btn-icon-left"><svg width="16" height="16">
												<use xlink:href="#olymp-facebook-icon"></use>
											</svg>Login with Facebook</a>

										<a href="#" class="btn btn-lg bg-twitter full-width btn-icon-left"><svg width="16" height="16">
