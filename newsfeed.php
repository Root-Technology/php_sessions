                            ...
                            <div class="tab-pane fade active show" id="home-1" role="tabpanel" aria-expanded="true">
                                <form action="create-post.php" method="post" enctype="multipart/form-data">
                                    <div class="author-thumb">
                                        <img loading="lazy" src="img/author-page.webp" width="36" height="36"
                                            alt="author">
                                    </div>
                                    ...
                                    <div class="add-options-message">
                                        ...
                                        <button class="btn btn-md-2 btn-border-think btn-transparent c-grey"
                    ...
                    <div class="ui-block">
                        ...
                        <article class="hentry post has-post-thumbnail shared-photo">
                            ...
                            <div class="post__author author vcard inline-items">
                                ...
                                <img loading="lazy" src="./uploads/profile/<?php echo $profilephoto ?>" alt="author"
                                    width="36" height="36">
                                <?php } else {
													if ($genderprofile == 'Male') { ?>
                                <img loading="lazy" src="https://i.ibb.co/854VS2Z/avatar5.png" alt="authorM" width="36"
                                    height="36">
                                <?php } elseif ($genderprofile == 'Female') { ?>
                                <img loading="lazy" src="https://i.ibb.co/3kgHdxm/avatar2.png" alt="authorF" width="36"
                                    height="36">
                                <?php }
												} ?>
                                ...
                                <div class="author-date">
                                    <a class="h6 post__author-name fn"
                                        href="02-ProfilePage.html"><?php echo $row1['name']; ?>
                                        <?php echo $row1['last_name']; ?></a>
                            ...
                            <div class="post-thumb">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <video src="uploads/post/<?php echo $row['post_video']; ?>" controls
                                                width="618" height="412"></video>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe
                                                src="https://www.youtube.com/embed/<?php echo $row['post_yt']; ?>?rel=0&amp;showinfo=0"
                                                width="618" height="412"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <?php
                        ...
                        <div class="content">
                          ...
                          $sql = "SELECT birthday FROM users WHERE id_user = $post_id_user";
                           $result = $conn->query($sql);
                            ...
                            $birthdayDate = $row['birthday'];

                         // Calculate the number of days left until the birthday
                          $daysLeft = daysUntilBirthday($birthdayDate);

                         echo "<p>There are {$daysLeft} days left until the birthday!</p>";
                       } else {
                     echo "<p>User not found or birthday data missing.</p>";
                      }
                    ?>
                        </div>
                    ...
                    <div class="ui-block">
                        ...
                        <ul class="widget w-activity-feed notification-list">
                            <li>
                                ...
                                <div class="notification-event">
                                    <a href="#" class="h6 notification-friend">Marina Polson</a> commented on Jason
                                    Mark’s
                            ...
                            <li>
                                ...
                                <div class="notification-event">
                                    <a href="#" class="h6 notification-friend">Mary Jane Stark </a> added 20 new photos
                                    to
                            ...
                            <li>
                                ...
                                <div class="notification-event">
                                    <a href="#" class="h6 notification-friend">Elaine Dreyfuss </a> liked your <a
                            ...
                            <li>
                                ...
                                <div class="notification-event">
                                    <a href="#" class="h6 notification-friend">Bruce Peterson </a> changed his <a
                                        href="#" class="notification-link">profile picture</a>.
                                    <span class="notification-date"><time class="entry-date updated"
