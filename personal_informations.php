							...
							<div class="row">
								...
								<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="form-group label-floating">
										...
										<input class="form-control" name="name" placeholder="" type="text" value="<?php echo $name; ?>">
									</div>

									<div class=" form-group label-floating">
										<label class="control-label">Your Email</label>
										<input class="form-control" name="email" placeholder="" type="email" value="<?php echo $email; ?>">
									</div>
								...
								<div class=" col col-lg-6 col-md-6 col-sm-12 col-12">
									...
									<div class="form-group label-floating">
										...
										<input class="form-control" name="website" placeholder="" type="text" value="<?php echo $website; ?>">
									</div>


									<div class="form-group label-floating is-empty">
										<label class="control-label">Your Phone Number</label>
										<input class="form-control" name="phone" placeholder="" type="text" value="<?php echo $phone; ?>">
									</div>
								</div>
								...
								<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="form-group">
										<textarea class="form-control" name="about" placeholder="Write a little description about you"><?php echo $about; ?></textarea>
									</div>
...
<!-- Mirrored from html.crumina.net/html-olympus/28-YourAccount-PersonalInformation.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Aug 2023 17:49:35 GMT -->
