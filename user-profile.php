...
<body class="page-has-left-panels page-has-right-panels">
    ...
    <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
      ...
      <div class="mCustomScrollbar" data-mcs-theme="dark">
        ...
        <div class="profile-completion">
          ...
          <span>Complete <a href="#">your profile</a> so people can know more
            about you!</span>
        </div>
      </div>
    </div>
  ...
  <div class="fixed-sidebar right">
    ...
    <div class="fixed-sidebar-right sidebar--large" id="sidebar-right-1">
      ...
      <div class="search-friend inline-items">
        <form class="form-group" method="POST" action="updateUser.php">
          ...
          <ul class="notification-list">
            ...
            <li class="with-comment-photo-wrap">
              ...
              <div class="comment-photo">
                ...
                <span>“She looks incredible in that outfit! We should see
                  each...”</span>
              </div>
              <div class="more">
                <svg class="olymp-three-dots-icon">
              ...
              <div class="row">
                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="form-group label-floating">
                    ...
                    <input class="form-control" placeholder="" type="text" name='name' value="<?php echo $name; ?>" />
                  </div>


                  <div class="form-group label-floating">
                    <label class="control-label">Your Email</label>
                    <input class="form-control" placeholder="" type="email" name='email' value="<?php echo  $email ?>" />
                  </div>
